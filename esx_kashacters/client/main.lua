...
AddEventHandler('kashactersC:SetupCharacters', function()
    ...
    cam = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", 681.71, 164.52, 920.41, 683.00, 0.00, 0.00, 100.00, false, 0)
...
AddEventHandler('kashactersC:SpawnCharacter', function(spawn, isnew)
    ...
    DoScreenFadeIn(500)
    Citizen.Wait(500)
    cam2 = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", 681.71, 164.52, 920.41, 683.00, 0.00, 0.00, 100.00, false, 0)
    ...
    cam =
        CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", pos.x, pos.y, pos.z + 200, 683.00, 0.00, 0.00, 100.00, false, 0)
